...
class TestStudentShow(TestFlaskBase):
    ...
    def test_show_single_student_inserted(self):
        ...
        response = self.client.get(
            url_for('student.listOneAll'), headers=token)
    ...
    def test_show_by_student_id(self):
        ...
        response = self.client.get(
            url_for('student.listOneAll',
                    student_id=response_student.json['student_id']),
            headers=token)
        self.assertEqual(1, len(response.json))
    ...
    def test_show_by_student_name(self):
        ...
        response = self.client.get(
            url_for('student.listOneAll',
                    name=response_student.json['name']),
            headers=token)
    ...
    def test_show_by_student_email(self):
        ...
        response = self.client.get(
            url_for('student.listOneAll',
                    email=response_student.json['email']),
            headers=token)
    ...
    def test_show_by_student_grade(self):
        ...
        response = self.client.get(
            url_for('student.listOneAll',
                    grade=response_student.json['grade_id']),
            headers=token)
